...
<div class="container-fluid main-blog position-relative">
    ...
    <div class="row" style="background-image: url({{ asset('images/mainbg.png') }}); background-size: cover; height: 677px;">
        ...
        <h1 class="text-fut-bold font-weight-bold text-white" style="font-size: 35px; line-height: 100%; letter-spacing: 0.05em;">
            ...
            <a href="/catalog">
            <button class="text-fut-book but-hov" style="margin-top: 5%; font-size: 16px; line-height: 21px; color:#444; padding: 15px 21px; border: 1px rgba(34,34,34,0.36) solid; background: transparent; cursor: pointer;">
                Смотреть все книги
            </button>
            </a>
        </div>
        ...
        <div class="row p-lg-5">
            <div class="col-lg-6 col-12 cat-scale" style="background-image: url({{ asset('images/cat1.png') }}); background-size: cover; height: 324px; box-shadow: 0px 4px 50px rgba(0, 0, 0, 0.25);">
                ...
                <div style="position: absolute; bottom: 28%; left:10%;">
                    ...
                    <p class="text-fut-bold text-scale" style="font-size: 16px; line-height: 120%; letter-spacing: 0.05em; color: #444;">
    ...
    <div class="container pt-lg-0 pt-4" id="schet" style="margin-top: 5%;">
        ...
        <div class="row pb-5">
            <div class="col-lg-5 col-12">
                ...
                <p class="text-fut-light pt-3" style="font-size: 18px; line-height: 140%; letter-spacing: 0.05em; color: #444;">
