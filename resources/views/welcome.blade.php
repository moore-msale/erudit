    ...
    <div class="container-fluid">
        <div class="row"
            ...
            <div class="col-lg-5 col-12" style="padding-left: 10%; padding-top:16%;">
                <h1 class="text-fut-bold font-weight-bold"
                    style="font-size: 50px; line-height: 100%; letter-spacing: 0.05em;">
                ...
                <a href="/catalog">
                    <button class="text-fut-bold font-weight-bold"
                            style="margin-top: 5%; font-size: 16px; line-height: 21px; color:black; padding: 15px 21px; border: 1px #000000 solid; background: transparent;">
                        Смотреть все книги
                    </button>
                </a>
            </div>
            ...
            <div class="col-lg-9 col-12 pl-lg-5 pl-4">
                <div class="row">
                    <div class="col-lg-4 col-12 pt-lg-0 pt-5">
                        <h3 class="text-fut-bold"
                            style="font-size: 30px; line-height: 120%; letter-spacing: 0.05em; color: #222222;">
                            Новинки 2019
                        </h3>
                    </div>
        ...
        <div class="p-lg-5 p-0">
            <div class="row p-lg-5">
                <div class="col-lg-6 col-12"
                     style="background-image: url({{ asset('images/cat1.png') }}); background-size: cover; height: 294px; box-shadow: 0px 4px 50px rgba(0, 0, 0, 0.25);">
        ...
        <div class="row">
            <div class="col-lg-5 col-12">
                ...
                <p class="text-fut-light pt-3"
                   style="font-size: 18px; line-height: 140%; letter-spacing: 0.05em; color: #000000;">
            ...
            <div class="col-lg-4 col-12 text-center">
                <div class="row">
                    ...
                    <div class="col-9 text-left">
                        <h4 class="text-fut-bold pt-3" style="font-size: 17px; line-height: 22px;">Заголовок
                            преимущества</h4>
