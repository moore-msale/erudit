        ...
        <div class="item my-4 ml-4 p-4 shadow text-scale" style="background-color: white; height: 480px">
            ...
            <div class="container-fluid mr-0 pr-0" style="position: absolute; bottom:7%;">
                ...
                <div class="p-0 text-left">
                    @guest
                    <span class="text-fut-book" style="font-size:18px; letter-spacing: 0.05em; color: #222;">
                    ...
                    <i style="color: #222; cursor: pointer;" class="fas fa-cart-plus fa-lg icon-flip buy"></i>
                </div>
                </div>
            </div>
        </div>
